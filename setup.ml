...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4ebe6507bcf1a17e7b8119e83e1942d2) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = ["Syndic_common"];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\171\017M\221\025$\028'\r7\173\022\174\246\168=";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
...
let _ =
  let homepage () =
    match setup_t.BaseSetup.package.homepage with
    | Some h -> h
    | None -> "" in
